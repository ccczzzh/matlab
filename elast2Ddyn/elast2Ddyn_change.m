...
[m,n]=size(llffunc);
llffunc(m-1000:m,2)=zeros(1001,1);
dlffunc = dlffunc';
llffunc = llffunc';
%
...
ForcingTerm = llfactor*F-K*U-C*V;
ForcingTerm = ForcingTerm(freedoftable);
ForcingTerm = ForcingTerm - M(freedoftable,fixeddoftable)*A(fixeddoftable)-C(freedoftable,fixeddoftable)*V(fixeddoftable);
